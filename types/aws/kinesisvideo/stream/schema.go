...
// Resource Resource Type Definition for AWS::KinesisVideo::Stream
...
// Tag A key-value pair to associated with the Kinesis Video Stream.
type Tag struct {
...
func (strct *Resource) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "DataRetentionInHours" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"DataRetentionInHours\": ")
	if tmp, err := json.Marshal(strct.DataRetentionInHours); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "MediaType" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"MediaType\": ")
	if tmp, err := json.Marshal(strct.MediaType); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *Resource) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "DataRetentionInHours":
            if err := json.Unmarshal([]byte(v), &strct.DataRetentionInHours); err != nil {
                return err
             }
        case "DeviceName":
        ...
        case "MediaType":
            if err := json.Unmarshal([]byte(v), &strct.MediaType); err != nil {
                return err
             }
        case "Name":
