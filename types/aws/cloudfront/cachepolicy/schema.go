...
func (strct *CachePolicyConfig) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // "ParametersInCacheKeyAndForwardedToOrigin" field is required
    if strct.ParametersInCacheKeyAndForwardedToOrigin == nil {
        return nil, errors.New("ParametersInCacheKeyAndForwardedToOrigin is a required field")
    }
    // Marshal the "ParametersInCacheKeyAndForwardedToOrigin" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"ParametersInCacheKeyAndForwardedToOrigin\": ")
	if tmp, err := json.Marshal(strct.ParametersInCacheKeyAndForwardedToOrigin); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *CachePolicyConfig) UnmarshalJSON(b []byte) error {
    DefaultTTLReceived := false
    MaxTTLReceived := false
    MinTTLReceived := false
    NameReceived := false
    ParametersInCacheKeyAndForwardedToOriginReceived := false
    ...
    for k, v := range jsonMap {
        ...
        case "ParametersInCacheKeyAndForwardedToOrigin":
            if err := json.Unmarshal([]byte(v), &strct.ParametersInCacheKeyAndForwardedToOrigin); err != nil {
                return err
             }
            ParametersInCacheKeyAndForwardedToOriginReceived = true
        default:
            return fmt.Errorf("additional property not allowed: \"" + k + "\"")
        }
    }
    // check if DefaultTTL (a required property) was received
    if !DefaultTTLReceived {
        return errors.New("\"DefaultTTL\" is required but was not present")
    }
    // check if MaxTTL (a required property) was received
    if !MaxTTLReceived {
        return errors.New("\"MaxTTL\" is required but was not present")
    }
    // check if MinTTL (a required property) was received
    if !MinTTLReceived {
        return errors.New("\"MinTTL\" is required but was not present")
    }
    // check if Name (a required property) was received
    if !NameReceived {
        return errors.New("\"Name\" is required but was not present")
    }
    // check if ParametersInCacheKeyAndForwardedToOrigin (a required property) was received
    if !ParametersInCacheKeyAndForwardedToOriginReceived {
        return errors.New("\"ParametersInCacheKeyAndForwardedToOrigin\" is required but was not present")
    }
    return nil
}
...
func (strct *ParametersInCacheKeyAndForwardedToOrigin) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "EnableAcceptEncodingBrotli" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"EnableAcceptEncodingBrotli\": ")
	if tmp, err := json.Marshal(strct.EnableAcceptEncodingBrotli); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	comma = true
    // "EnableAcceptEncodingGzip" field is required
    // only required object types supported for marshal checking (for now)
    // Marshal the "EnableAcceptEncodingGzip" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"EnableAcceptEncodingGzip\": ")
	if tmp, err := json.Marshal(strct.EnableAcceptEncodingGzip); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *ParametersInCacheKeyAndForwardedToOrigin) UnmarshalJSON(b []byte) error {
    ...
    EnableAcceptEncodingGzipReceived := false
    ...
    for k, v := range jsonMap {
        ...
        case "EnableAcceptEncodingBrotli":
            if err := json.Unmarshal([]byte(v), &strct.EnableAcceptEncodingBrotli); err != nil {
                return err
             }
        case "EnableAcceptEncodingGzip":
            if err := json.Unmarshal([]byte(v), &strct.EnableAcceptEncodingGzip); err != nil {
                return err
             }
            EnableAcceptEncodingGzipReceived = true
        case "HeadersConfig":
    ...
    // check if EnableAcceptEncodingGzip (a required property) was received
    if !EnableAcceptEncodingGzipReceived {
        return errors.New("\"EnableAcceptEncodingGzip\" is required but was not present")
    }
...
func (strct *Resource) MarshalJSON() ([]byte, error) {
	...
	buf.WriteString("{")
    comma := false
    // "CachePolicyConfig" field is required
    if strct.CachePolicyConfig == nil {
        return nil, errors.New("CachePolicyConfig is a required field")
    }
    // Marshal the "CachePolicyConfig" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"CachePolicyConfig\": ")
	if tmp, err := json.Marshal(strct.CachePolicyConfig); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *Resource) UnmarshalJSON(b []byte) error {
    CachePolicyConfigReceived := false
    var jsonMap map[string]json.RawMessage
    if err := json.Unmarshal(b, &jsonMap); err != nil {
        return err
    }
    ...
    for k, v := range jsonMap {
        ...
        case "CachePolicyConfig":
            if err := json.Unmarshal([]byte(v), &strct.CachePolicyConfig); err != nil {
                return err
             }
            CachePolicyConfigReceived = true
        case "Id":
    ...
    // check if CachePolicyConfig (a required property) was received
    if !CachePolicyConfigReceived {
        return errors.New("\"CachePolicyConfig\" is required but was not present")
    }
    return nil
}
