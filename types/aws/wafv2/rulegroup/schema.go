...
// All Inspect all parts of the web request headers.
type All struct {
}
...
// CountAction Count traffic towards application.
...
// Resource Contains the Rules that identify the requests that you want to allow, block, or count. In a RuleGroup, you also specify a default action (ALLOW or BLOCK), and the action for each Rule that you add to a RuleGroup, for example, block requests from specified IP addresses or block requests from specified referrers. You also associate the RuleGroup with a CloudFront distribution to identify the requests that you want AWS WAF to filter. If you add more than one Rule to a RuleGroup, a request needs to match only one of the specifications to be allowed, blocked, or counted.
...
// Rule Rule of RuleGroup that contains condition and action.
type Rule struct {
...
// UriPath The path component of the URI of a web request. This is the part of a web request that identifies a resource, for example, /images/daily-ad.jpg.
type UriPath struct {
}

// VisibilityConfig Visibility Metric of the RuleGroup.
...
func (strct *LabelSummary) MarshalJSON() ([]byte, error) {
	buf := bytes.NewBuffer(make([]byte, 0))
	buf.WriteString("{")
    comma := false
    // Marshal the "Name" field
...
func (strct *LabelSummary) UnmarshalJSON(b []byte) error {
    var jsonMap map[string]json.RawMessage
    if err := json.Unmarshal(b, &jsonMap); err != nil {
        return err
    }
...
func (strct *Resource) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "AvailableLabels" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"AvailableLabels\": ")
	if tmp, err := json.Marshal(strct.AvailableLabels); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "ConsumedLabels" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"ConsumedLabels\": ")
	if tmp, err := json.Marshal(strct.ConsumedLabels); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *Resource) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "AvailableLabels":
            if err := json.Unmarshal([]byte(v), &strct.AvailableLabels); err != nil {
                return err
             }
        case "Capacity":
        ...
        case "ConsumedLabels":
            if err := json.Unmarshal([]byte(v), &strct.ConsumedLabels); err != nil {
                return err
             }
